...
class lowMSSM_slha : public lowMSSM_mass_eigenstates {
public:
   explicit lowMSSM_slha(const lowMSSM_input_parameters& input_ = lowMSSM_input_parameters(), bool do_convert_masses_to_slha = true);
   explicit lowMSSM_slha(const lowMSSM_mass_eigenstates&, bool do_convert_masses_to_slha = true);
