...
void lowMSSM_slha_io::set_normalized_effectivecouplings_block(const EffectiveCoupling_list& effCouplings) {
   slha_io.set_normalized_effectivecouplings_block(effCouplings);
}

void lowMSSM_slha_io::set_imnormalized_effectivecouplings_block(const EffectiveCoupling_list& effCouplings) {
 ...
 */
void lowMSSM_slha_io::set_decays(const lowMSSM_decay_table& decay_table, FlexibleDecay_settings const& flexibledecay_settings)
{
   for (const auto& particle : decay_table) {
      set_decay_block(particle, flexibledecay_settings);
   }
}
void lowMSSM_slha_io::fill_decays_data(const lowMSSM_decays& decays, FlexibleDecay_settings const& flexibledecay_settings)
{
...
void lowMSSM_slha_io::set_hs_or_lilith(std::string const& block_name, const int ndof, const double chi2, const double chi2SMmin, const double mhSM, const double pval)
{
   slha_io.set_hs_or_lilith(block_name, ndof, chi2, chi2SMmin, mhSM, pval);
}

void lowMSSM_slha_io::set_higgsbounds(std::vector<std::tuple<int, double, double, std::string>> const& hb)
{
