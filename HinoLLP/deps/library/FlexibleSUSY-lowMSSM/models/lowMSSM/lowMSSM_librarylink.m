...
FSlowMSSMCalculateDecays = LibraryFunctionLoad[liblowMSSM, "FSlowMSSMCalculateDecays", LinkObject, LinkObject];

FSlowMSSMCalculateNormalizedEffectiveCouplings = LibraryFunctionLoad[liblowMSSM, "FSlowMSSMCalculateNormalizedEffectiveCouplings", LinkObject, LinkObject];
FSlowMSSMCallHiggsTools = LibraryFunctionLoad[liblowMSSM, "FSlowMSSMCallHiggsTools", LinkObject, LinkObject];
FSlowMSSMCallLilith = LibraryFunctionLoad[liblowMSSM, "FSlowMSSMCallLilith", LinkObject, LinkObject];

FSlowMSSMCalculateUnitarity = LibraryFunctionLoad[liblowMSSM, "FSlowMSSMCalculateUnitarity", LinkObject, LinkObject];
...
FSlowMSSMCalculateDecays::error = "`1`";
FSlowMSSMCalculateDecays::warning = "`1`";


FSlowMSSMCallLilith::error = "`1`";
FSlowMSSMCallLilith::warning = "`1`";


FSlowMSSMCalculateUnitarity::error = "`1`";
FSlowMSSMCalculateUnitarity::warning = "`1`";
...
FSlowMSSMOpenHandle[a___, (fsSettings | fsSMParameters | fsModelParameters | fdSettings) -> s_List, r___] :=
