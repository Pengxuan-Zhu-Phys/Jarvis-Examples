...
public:
   ...
   std::complex<double> self_energy_hh_1loop_deriv_p2(double p , int gO1, int gO2) const;
   Eigen::Matrix<std::complex<double>,2,2> self_energy_hh_1loop_deriv_p2(double p) const;
