...
// lowMSSM_parameter_getter ////////////////////////////////////////

std::vector<std::string> lowMSSM_parameter_getter::get_mass_names(const std::string& head)
{
...
std::array<std::string, lowMSSM_info::NUMBER_OF_MIXINGS> lowMSSM_parameter_getter::get_mixing_names()
{
   return lowMSSM_info::particle_mixing_names;
}

Eigen::ArrayXd lowMSSM_parameter_getter::get_parameters(const lowMSSM_mass_eigenstates& model)
{
   return model.get();
}

std::array<std::string, lowMSSM_info::NUMBER_OF_PARAMETERS> lowMSSM_parameter_getter::get_parameter_names()
{
   return lowMSSM_info::parameter_names;
}

std::array<std::string, lowMSSM_info::NUMBER_OF_PARTICLES> lowMSSM_parameter_getter::get_particle_names()
{
   return lowMSSM_info::particle_names;
}

std::vector<std::string> lowMSSM_parameter_getter::get_DRbar_mass_names()
{
   return get_mass_names();
}

std::vector<std::string> lowMSSM_parameter_getter::get_pole_mass_names()
{
   return get_mass_names("Pole");
}

std::array<std::string, lowMSSM_info::NUMBER_OF_MIXINGS> lowMSSM_parameter_getter::get_DRbar_mixing_names()
{
   return get_mixing_names();
}

std::array<std::string, lowMSSM_info::NUMBER_OF_MIXINGS> lowMSSM_parameter_getter::get_pole_mixing_names()
{
...
std::array<std::string, lowMSSM_info::NUMBER_OF_INPUT_PARAMETERS> lowMSSM_parameter_getter::get_input_parameter_names()
{
   return lowMSSM_info::input_parameter_names;
}

std::array<std::string, lowMSSM_info::NUMBER_OF_EXTRA_PARAMETERS> lowMSSM_parameter_getter::get_extra_parameter_names()
{
   return lowMSSM_info::extra_parameter_names;
}

decltype(lowMSSM_info::NUMBER_OF_MASSES) lowMSSM_parameter_getter::get_number_of_masses()
{
