...
std::complex<double> CLASSNAME::self_energy_hh_1loop_deriv_p2(double p , int gO1, int gO2) const
{
   std::complex<double> result;

   result += -(CpbargWmCgWmCUhh(gO1)*CpbargWmCgWmCUhh(gO2)*DB0(Sqr(p),Sqr(MVWm),
      Sqr(MVWm)));
   result += -(CpbargWmgWmUhh(gO1)*CpbargWmgWmUhh(gO2)*DB0(Sqr(p),Sqr(MVWm),Sqr(
      MVWm)));
   result += 4*Conj(CpUhhconjVWmVWm(gO2))*CpUhhconjVWmVWm(gO1)*DB0(Sqr(p),Sqr(MVWm
      ),Sqr(MVWm));
   result += -(CpbargZgZUhh(gO1)*CpbargZgZUhh(gO2)*DB0(Sqr(p),Sqr(MVZ),Sqr(MVZ)));
   result += 2*Conj(CpUhhVZVZ(gO2))*CpUhhVZVZ(gO1)*DB0(Sqr(p),Sqr(MVZ),Sqr(MVZ));
   result += 0.5*SUM(gI1,0,1,SUM(gI2,0,1,Conj(CpAhAhUhh(gI1,gI2,gO2))*CpAhAhUhh(
      gI1,gI2,gO1)*DB0(Sqr(p),Sqr(MAh(gI1)),Sqr(MAh(gI2)))));
   result += 0.5*SUM(gI1,0,1,SUM(gI2,0,1,Conj(CphhhhUhh(gI1,gI2,gO2))*CphhhhUhh(
      gI1,gI2,gO1)*DB0(Sqr(p),Sqr(Mhh(gI1)),Sqr(Mhh(gI2)))));
   result += SUM(gI1,0,1,SUM(gI2,0,1,Conj(CpUhhHpmconjHpm(gO2,gI2,gI1))*
      CpUhhHpmconjHpm(gO1,gI2,gI1)*DB0(Sqr(p),Sqr(MHpm(gI1)),Sqr(MHpm(gI2)))));
   result += SUM(gI1,0,1,SUM(gI2,0,1,(Conj(CpbarChaChaUhhPL(gI1,gI2,gO2))*
      CpbarChaChaUhhPL(gI1,gI2,gO1) + Conj(CpbarChaChaUhhPR(gI1,gI2,gO2))*
      CpbarChaChaUhhPR(gI1,gI2,gO1))*DG0(Sqr(p),Sqr(MCha(gI1)),Sqr(MCha(gI2)))));
   result += -2*SUM(gI1,0,1,MCha(gI1)*SUM(gI2,0,1,(Conj(CpbarChaChaUhhPR(gI1,gI2,
      gO2))*CpbarChaChaUhhPL(gI1,gI2,gO1) + Conj(CpbarChaChaUhhPL(gI1,gI2,gO2))*
      CpbarChaChaUhhPR(gI1,gI2,gO1))*DB0(Sqr(p),Sqr(MCha(gI1)),Sqr(MCha(gI2)))*
      MCha(gI2)));
   result += SUM(gI1,0,2,SUM(gI2,0,2,Conj(CpUhhSvconjSv(gO2,gI2,gI1))*
      CpUhhSvconjSv(gO1,gI2,gI1)*DB0(Sqr(p),Sqr(MSv(gI1)),Sqr(MSv(gI2)))));
   result += 3*SUM(gI1,0,2,SUM(gI2,0,2,(Conj(CpbarFdFdUhhPL(gI1,gI2,gO2))*
      CpbarFdFdUhhPL(gI1,gI2,gO1) + Conj(CpbarFdFdUhhPR(gI1,gI2,gO2))*
      CpbarFdFdUhhPR(gI1,gI2,gO1))*DG0(Sqr(p),Sqr(MFd(gI1)),Sqr(MFd(gI2)))));
   result += SUM(gI1,0,2,SUM(gI2,0,2,(Conj(CpbarFeFeUhhPL(gI1,gI2,gO2))*
      CpbarFeFeUhhPL(gI1,gI2,gO1) + Conj(CpbarFeFeUhhPR(gI1,gI2,gO2))*
      CpbarFeFeUhhPR(gI1,gI2,gO1))*DG0(Sqr(p),Sqr(MFe(gI1)),Sqr(MFe(gI2)))));
   result += 3*SUM(gI1,0,2,SUM(gI2,0,2,(Conj(CpbarFuFuUhhPL(gI1,gI2,gO2))*
      CpbarFuFuUhhPL(gI1,gI2,gO1) + Conj(CpbarFuFuUhhPR(gI1,gI2,gO2))*
      CpbarFuFuUhhPR(gI1,gI2,gO1))*DG0(Sqr(p),Sqr(MFu(gI1)),Sqr(MFu(gI2)))));
   result += -6*SUM(gI1,0,2,MFd(gI1)*SUM(gI2,0,2,(Conj(CpbarFdFdUhhPR(gI1,gI2,gO2)
      )*CpbarFdFdUhhPL(gI1,gI2,gO1) + Conj(CpbarFdFdUhhPL(gI1,gI2,gO2))*
      CpbarFdFdUhhPR(gI1,gI2,gO1))*DB0(Sqr(p),Sqr(MFd(gI1)),Sqr(MFd(gI2)))*MFd(gI2
      )));
   result += -2*SUM(gI1,0,2,MFe(gI1)*SUM(gI2,0,2,(Conj(CpbarFeFeUhhPR(gI1,gI2,gO2)
      )*CpbarFeFeUhhPL(gI1,gI2,gO1) + Conj(CpbarFeFeUhhPL(gI1,gI2,gO2))*
      CpbarFeFeUhhPR(gI1,gI2,gO1))*DB0(Sqr(p),Sqr(MFe(gI1)),Sqr(MFe(gI2)))*MFe(gI2
      )));
   result += -6*SUM(gI1,0,2,MFu(gI1)*SUM(gI2,0,2,(Conj(CpbarFuFuUhhPR(gI1,gI2,gO2)
      )*CpbarFuFuUhhPL(gI1,gI2,gO1) + Conj(CpbarFuFuUhhPL(gI1,gI2,gO2))*
      CpbarFuFuUhhPR(gI1,gI2,gO1))*DB0(Sqr(p),Sqr(MFu(gI1)),Sqr(MFu(gI2)))*MFu(gI2
      )));
   result += 0.5*SUM(gI1,0,3,SUM(gI2,0,3,(Conj(CpChiChiUhhPL(gI1,gI2,gO2))*
      CpChiChiUhhPL(gI1,gI2,gO1) + Conj(CpChiChiUhhPR(gI1,gI2,gO2))*CpChiChiUhhPR(
      gI1,gI2,gO1))*DG0(Sqr(p),Sqr(MChi(gI1)),Sqr(MChi(gI2)))));
   result += -SUM(gI1,0,3,MChi(gI1)*SUM(gI2,0,3,(Conj(CpChiChiUhhPR(gI1,gI2,gO2))*
      CpChiChiUhhPL(gI1,gI2,gO1) + Conj(CpChiChiUhhPL(gI1,gI2,gO2))*CpChiChiUhhPR(
      gI1,gI2,gO1))*DB0(Sqr(p),Sqr(MChi(gI1)),Sqr(MChi(gI2)))*MChi(gI2)));
   result += 3*SUM(gI1,0,5,SUM(gI2,0,5,Conj(CpUhhSdconjSd(gO2,gI2,gI1))*
      CpUhhSdconjSd(gO1,gI2,gI1)*DB0(Sqr(p),Sqr(MSd(gI1)),Sqr(MSd(gI2)))));
   result += SUM(gI1,0,5,SUM(gI2,0,5,Conj(CpUhhSeconjSe(gO2,gI2,gI1))*
      CpUhhSeconjSe(gO1,gI2,gI1)*DB0(Sqr(p),Sqr(MSe(gI1)),Sqr(MSe(gI2)))));
   result += 3*SUM(gI1,0,5,SUM(gI2,0,5,Conj(CpUhhSuconjSu(gO2,gI2,gI1))*
      CpUhhSuconjSu(gO1,gI2,gI1)*DB0(Sqr(p),Sqr(MSu(gI1)),Sqr(MSu(gI2)))));
   result += SUM(gI2,0,1,Conj(CpAhUhhVZ(gI2,gO2))*CpAhUhhVZ(gI2,gO1)*DF0(Sqr(p),
      Sqr(MAh(gI2)),Sqr(MVZ)));
   result += 2*SUM(gI2,0,1,Conj(CpUhhHpmconjVWm(gO2,gI2))*CpUhhHpmconjVWm(gO1,gI2)
      *DF0(Sqr(p),Sqr(MHpm(gI2)),Sqr(MVWm)));

   return result * oneOver16PiSqr;
}

Eigen::Matrix<std::complex<double>,2,2> CLASSNAME::self_energy_hh_1loop_deriv_p2(double p) const
{
   Eigen::Matrix<std::complex<double>,2,2> self_energy;

   for (int i = 0; i < 2; i++) {
      for (int k = i; k < 2; k++) {
         self_energy(i, k) = self_energy_hh_1loop_deriv_p2(p, i, k);
      }
   }
