{{{Ah[{gt1}], hh[{gt2}], VZ[{lt3}]}, 
 ...
 {{Hpm[{gt1}], conj[Hpm[{gt2}]], VP[{lt3}]}, 
  ...
  {(I/2)*(g2*Cos[ThetaW] - g1*Sin[ThetaW])*(ZP[gt1, 1]*ZP[gt2, 1] + 
   ...
   VG[{ct3, lt3}]}, {(-1/2*I)*g3*Lam[ct3, ct2, ct1]*
 ...
 {{Su[{gt1, ct1}], conj[Su[{gt2, ct2}]], VG[{ct3, lt3}]}, 
  {(-1/2*I)*g3*Lam[ct3, ct2, ct1]*sumExp[j1, 1, 6, 
     conj[ZU[gt1, j1]]*ZU[gt2, j1]], -Mom[conj[Su[{gt2, ct2}]], lt3] + 
    Mom[Su[{gt1, ct1}], lt3]}}, {{Su[{gt1, ct1}], conj[Su[{gt2, ct2}]], 
   VP[{lt3}]}, {(-1/6*I)*Delta[ct1, ct2]*
    ((g1*Cos[ThetaW] + 3*g2*Sin[ThetaW])*sumExp[j1, 1, 3, 
       conj[ZU[gt1, j1]]*ZU[gt2, j1]] + 4*g1*Cos[ThetaW]*
      sumExp[j1, 1, 3, conj[ZU[gt1, 3 + j1]]*ZU[gt2, 3 + j1]]), 
   -Mom[conj[Su[{gt2, ct2}]], lt3] + Mom[Su[{gt1, ct1}], lt3]}}, 
 {{Su[{gt1, ct1}], conj[Sd[{gt2, ct2}]], VWm[{lt3}]}, 
  {((-I)*g2*Delta[ct1, ct2]*sumExp[j1, 1, 3, conj[ZU[gt1, j1]]*ZD[gt2, j1]])/
 ...
 {{Sv[{gt1}], conj[Sv[{gt2}]], VZ[{lt3}]}, 
  {(-1/2*I)*(g2*Cos[ThetaW] + g1*Sin[ThetaW])*sumExp[j1, 1, 3, 
