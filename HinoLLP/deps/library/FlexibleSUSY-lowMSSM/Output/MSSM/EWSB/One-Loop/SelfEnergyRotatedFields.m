{2*A0[Mass2[VZ]]*Cp[USd[{gO1}], conj[USd[{gO2}]], VZ, VZ] + 
  ...
  sum[gI2, 1, 6, conj[Cp[conj[USd[{gO2}]], VZ, Sd[{gI2}]]]*
    ...
    Cp[conj[USd[{gO1}]], VWm, Su[{gI2}]]*F0[p^2, Mass2[Su[{gI2}]], 
     Mass2[VWm]]], 2*A0[Mass2[VZ]]*Cp[USv[{gO1}], conj[USv[{gO2}]], VZ, VZ] + 
  ...
  sum[gI2, 1, 3, conj[Cp[conj[USv[{gO2}]], VZ, Sv[{gI2}]]]*
   ...
   conj[Cp[conj[USv[{gO2}]], conj[VWm], Se[{gI2}]]]*
    Cp[conj[USv[{gO1}]], conj[VWm], Se[{gI2}]]*F0[p^2, Mass2[Se[{gI2}]], 
     Mass2[VWm]]], 2*A0[Mass2[VZ]]*Cp[USu[{gO1}], conj[USu[{gO2}]], VZ, VZ] + 
  ...
  sum[gI2, 1, 6, conj[Cp[conj[USu[{gO2}]], VZ, Su[{gI2}]]]*
    Cp[conj[USu[{gO1}]], VZ, Su[{gI2}]]*F0[p^2, Mass2[Su[{gI2}]], 
     Mass2[VZ]]], 2*A0[Mass2[VZ]]*Cp[USe[{gO1}], conj[USe[{gO2}]], VZ, VZ] + 
  ...
  sum[gI2, 1, 6, conj[Cp[conj[USe[{gO2}]], VZ, Se[{gI2}]]]*
    Cp[conj[USe[{gO1}]], VZ, Se[{gI2}]]*F0[p^2, Mass2[Se[{gI2}]], 
     Mass2[VZ]]], 2*B0[p^2, Mass2[VZ], Mass2[VZ]]*
  ...
  B0[p^2, Mass2[gWmC], Mass2[gWmC]]*Cp[UAh[{gO1}], bar[gWmC], gWmC]*
   Cp[UAh[{gO2}], bar[gWmC], gWmC] + 2*A0[Mass2[VZ]]*
   Cp[UAh[{gO1}], UAh[{gO2}], VZ, VZ] + 4*A0[Mass2[VWm]]*
   Cp[UAh[{gO1}], UAh[{gO2}], conj[VWm], VWm] - 
  ...
  2*sum[gI2, 1, 2, conj[Cp[UAh[{gO2}], conj[VWm], Hpm[{gI2}]]]*
     Cp[UAh[{gO1}], conj[VWm], Hpm[{gI2}]]*F0[p^2, Mass2[Hpm[{gI2}]], 
      Mass2[VWm]]], 4*B0[p^2, 0, Mass2[VWm]]*
   conj[Cp[conj[UHpm[{gO2}]], VWm, VP]]*Cp[conj[UHpm[{gO1}]], VWm, VP] + 
  4*B0[p^2, Mass2[VWm], Mass2[VZ]]*conj[Cp[conj[UHpm[{gO2}]], VZ, VWm]]*
   Cp[conj[UHpm[{gO1}]], VZ, VWm] - B0[p^2, Mass2[gZ], Mass2[gWmC]]*
   Cp[conj[UHpm[{gO1}]], bar[gWmC], gZ]*Cp[UHpm[{gO2}], gWmC, bar[gZ]] - 
  B0[p^2, Mass2[gWm], Mass2[gZ]]*Cp[conj[UHpm[{gO1}]], bar[gZ], gWm]*
   Cp[UHpm[{gO2}], gZ, bar[gWm]] + 2*A0[Mass2[VZ]]*
   Cp[UHpm[{gO1}], conj[UHpm[{gO2}]], VZ, VZ] + 
 ...
 {sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fe[{gI2}]], Mass2[hh[{gI1}]]]*
  ...
  -1/2*sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fe[{gI2}]], 
        Mass2[hh[{gI1}]]]*conj[Cp[bar[UFe[{gO2}]], hh[{gI1}], Fe[{gI2}]][PR]]*
       Cp[bar[UFe[{gO1}]], hh[{gI1}], Fe[{gI2}]][PR]]] - 
  ...
  -1/2*sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fe[{gI2}]], 
       ...
       Cp[bar[UFe[{gO1}]], hh[{gI1}], Fe[{gI2}]][PL]]] - 
   sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fv[{gI2}]], Mass2[Hpm[{gI1}]]]*
 ...
 {sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fd[{gI2}]], Mass2[hh[{gI1}]]]*
  ...
  -1/2*sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fd[{gI2}]], 
        Mass2[hh[{gI1}]]]*conj[Cp[bar[UFd[{gO2}]], hh[{gI1}], Fd[{gI2}]][PR]]*
       Cp[bar[UFd[{gO1}]], hh[{gI1}], Fd[{gI2}]][PR]]] - 
  ...
  -1/2*sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fd[{gI2}]], 
       ...
       Cp[bar[UFd[{gO1}]], hh[{gI1}], Fd[{gI2}]][PL]]] - 
   sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fu[{gI2}]], Mass2[Hpm[{gI1}]]]*
