{{sum[gI1, 1, 3, Mass[Fd[{gI1}]]*sum[gI2, 1, 6, 
   ...
   12*B0[p^2, Mass2[Glu], 0]*conj[Cp[Glu[{gO2}], VG, Glu[{1}]][PR]]*Mass[Glu]*
    Cp[Glu[{gO1}], VG, Glu[{1}]][PL], 
  -1/4*sum[gI1, 1, 3, sum[gI2, 1, 6, B1[p^2, Mass2[Fd[{gI1}]], 
        Mass2[Sd[{gI2}]]]*conj[Cp[Glu[{gO2}], bar[Fd[{gI1}]], Sd[{gI2}]][PR]]*
       Cp[Glu[{gO1}], bar[Fd[{gI1}]], Sd[{gI2}]][PR]]] - 
   ...
   3*B1[p^2, Mass2[Glu], 0]*conj[Cp[Glu[{gO2}], VG, Glu[{1}]][PL]]*
    Cp[Glu[{gO1}], VG, Glu[{1}]][PL], 
  -1/4*sum[gI1, 1, 3, sum[gI2, 1, 6, B1[p^2, Mass2[Fd[{gI1}]], 
        Mass2[Sd[{gI2}]]]*conj[Cp[Glu[{gO2}], bar[Fd[{gI1}]], Sd[{gI2}]][PL]]*
       Cp[Glu[{gO1}], bar[Fd[{gI1}]], Sd[{gI2}]][PL]]] - 
   sum[gI1, 1, 3, sum[gI2, 1, 6, B1[p^2, Mass2[Fu[{gI1}]], Mass2[Su[{gI2}]]]*
       conj[Cp[Glu[{gO2}], bar[Fu[{gI1}]], Su[{gI2}]][PL]]*
 ...
 {sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fe[{gI2}]], Mass2[Hpm[{gI1}]]]*
   ...
   sum[gI1, 1, 3, sum[gI2, 1, 4, B0[p^2, Mass2[Chi[{gI2}]], Mass2[Sv[{gI1}]]]*
  ...
  -1/2*sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fe[{gI2}]], 
   ...
   sum[gI1, 1, 3, sum[gI2, 1, 4, B1[p^2, Mass2[Chi[{gI2}]], Mass2[Sv[{gI1}]]]*
 ...
 (3*(-2*A0[0] - 4*p^2*B0[p^2, 0, 0] - 10*B00[p^2, 0, 0])*conj[Cp[VG, VG, VG]]*
    Cp[VG, VG, VG])/2 + 3*B00[p^2, Mass2[gG], Mass2[gG]]*
  ...
  B00[p^2, Mass2[gWmC], Mass2[gWmC]]*conj[Cp[VP, bar[gWmC], gWmC]]*
   ...
   Cp[VP, conj[VWm], VWm]*(-2*A0[Mass2[VWm]] - 
    10*B00[p^2, Mass2[VWm], Mass2[VWm]] - B0[p^2, Mass2[VWm], Mass2[VWm]]*
