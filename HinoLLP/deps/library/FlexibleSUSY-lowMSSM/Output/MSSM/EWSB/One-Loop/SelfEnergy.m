{{Sd, 2*A0[Mass2[VZ]]*Cp[USd[{gO1}], conj[USd[{gO2}]], VZ, VZ] + 
   4*A0[Mass2[VWm]]*Cp[USd[{gO1}], conj[USd[{gO2}]], conj[VWm], VWm] - 
   sum[gI1, 1, 2, A0[Mass2[Ah[{gI1}]]]*Cp[USd[{gO1}], conj[USd[{gO2}]], 
       Ah[{gI1}], Ah[{gI1}]]]/2 - sum[gI1, 1, 2, A0[Mass2[Hpm[{gI1}]]]*
     Cp[USd[{gO1}], conj[USd[{gO2}]], conj[Hpm[{gI1}]], Hpm[{gI1}]]] - 
   ...
   sum[gI2, 1, 6, conj[Cp[conj[USd[{gO2}]], VZ, Sd[{gI2}]]]*
     ...
     Cp[conj[USd[{gO1}]], VWm, Su[{gI2}]]*F0[p^2, Mass2[Su[{gI2}]], 
      Mass2[VWm]]]}, 
 {Sv, 2*A0[Mass2[VZ]]*Cp[USv[{gO1}], conj[USv[{gO2}]], VZ, VZ] + 
   4*A0[Mass2[VWm]]*Cp[USv[{gO1}], conj[USv[{gO2}]], conj[VWm], VWm] - 
   sum[gI1, 1, 2, A0[Mass2[Ah[{gI1}]]]*Cp[USv[{gO1}], conj[USv[{gO2}]], 
       Ah[{gI1}], Ah[{gI1}]]]/2 - sum[gI1, 1, 2, A0[Mass2[Hpm[{gI1}]]]*
     Cp[USv[{gO1}], conj[USv[{gO2}]], conj[Hpm[{gI1}]], Hpm[{gI1}]]] - 
   ...
   sum[gI2, 1, 3, conj[Cp[conj[USv[{gO2}]], VZ, Sv[{gI2}]]]*
    ...
    conj[Cp[conj[USv[{gO2}]], conj[VWm], Se[{gI2}]]]*
     Cp[conj[USv[{gO1}]], conj[VWm], Se[{gI2}]]*F0[p^2, Mass2[Se[{gI2}]], 
      Mass2[VWm]]]}, 
 {Su, 2*A0[Mass2[VZ]]*Cp[USu[{gO1}], conj[USu[{gO2}]], VZ, VZ] + 
   4*A0[Mass2[VWm]]*Cp[USu[{gO1}], conj[USu[{gO2}]], conj[VWm], VWm] - 
   sum[gI1, 1, 2, A0[Mass2[Ah[{gI1}]]]*Cp[USu[{gO1}], conj[USu[{gO2}]], 
       Ah[{gI1}], Ah[{gI1}]]]/2 - sum[gI1, 1, 2, A0[Mass2[Hpm[{gI1}]]]*
     Cp[USu[{gO1}], conj[USu[{gO2}]], conj[Hpm[{gI1}]], Hpm[{gI1}]]] - 
   ...
   sum[gI2, 1, 6, conj[Cp[conj[USu[{gO2}]], VZ, Su[{gI2}]]]*
     Cp[conj[USu[{gO1}]], VZ, Su[{gI2}]]*F0[p^2, Mass2[Su[{gI2}]], 
      Mass2[VZ]]]}, 
 {Se, 2*A0[Mass2[VZ]]*Cp[USe[{gO1}], conj[USe[{gO2}]], VZ, VZ] + 
   4*A0[Mass2[VWm]]*Cp[USe[{gO1}], conj[USe[{gO2}]], conj[VWm], VWm] - 
   sum[gI1, 1, 2, A0[Mass2[Ah[{gI1}]]]*Cp[USe[{gO1}], conj[USe[{gO2}]], 
       Ah[{gI1}], Ah[{gI1}]]]/2 - sum[gI1, 1, 2, A0[Mass2[Hpm[{gI1}]]]*
     Cp[USe[{gO1}], conj[USe[{gO2}]], conj[Hpm[{gI1}]], Hpm[{gI1}]]] - 
   ...
   sum[gI2, 1, 6, conj[Cp[conj[USe[{gO2}]], VZ, Se[{gI2}]]]*
     Cp[conj[USe[{gO1}]], VZ, Se[{gI2}]]*F0[p^2, Mass2[Se[{gI2}]], 
      Mass2[VZ]]]}, {hh, 2*B0[p^2, Mass2[VZ], Mass2[VZ]]*
    conj[Cp[Uhh[{gO2}], VZ, VZ]]*Cp[Uhh[{gO1}], VZ, VZ] + 
   4*B0[p^2, Mass2[VWm], Mass2[VWm]]*conj[Cp[Uhh[{gO2}], conj[VWm], VWm]]*
    Cp[Uhh[{gO1}], conj[VWm], VWm] - B0[p^2, Mass2[gWm], Mass2[gWm]]*
    Cp[Uhh[{gO1}], bar[gWm], gWm]*Cp[Uhh[{gO2}], bar[gWm], gWm] - 
   B0[p^2, Mass2[gWmC], Mass2[gWmC]]*Cp[Uhh[{gO1}], bar[gWmC], gWmC]*
    Cp[Uhh[{gO2}], bar[gWmC], gWmC] - B0[p^2, Mass2[gZ], Mass2[gZ]]*
    Cp[Uhh[{gO1}], bar[gZ], gZ]*Cp[Uhh[{gO2}], bar[gZ], gZ] + 
   2*A0[Mass2[VZ]]*Cp[Uhh[{gO1}], Uhh[{gO2}], VZ, VZ] + 
   4*A0[Mass2[VWm]]*Cp[Uhh[{gO1}], Uhh[{gO2}], conj[VWm], VWm] - 
 ...
 {Ah, -(B0[p^2, Mass2[gWm], Mass2[gWm]]*Cp[UAh[{gO1}], bar[gWm], gWm]*
   ...
   2*A0[Mass2[VZ]]*Cp[UAh[{gO1}], UAh[{gO2}], VZ, VZ] + 
   4*A0[Mass2[VWm]]*Cp[UAh[{gO1}], UAh[{gO2}], conj[VWm], VWm] - 
   ...
   2*sum[gI2, 1, 2, conj[Cp[UAh[{gO2}], conj[VWm], Hpm[{gI2}]]]*
      Cp[UAh[{gO1}], conj[VWm], Hpm[{gI2}]]*F0[p^2, Mass2[Hpm[{gI2}]], 
       Mass2[VWm]]]}, 
 {Hpm, 4*B0[p^2, 0, Mass2[VWm]]*conj[Cp[conj[UHpm[{gO2}]], VWm, VP]]*
    Cp[conj[UHpm[{gO1}]], VWm, VP] + 4*B0[p^2, Mass2[VWm], Mass2[VZ]]*
   ...
   2*A0[Mass2[VZ]]*Cp[UHpm[{gO1}], conj[UHpm[{gO2}]], VZ, VZ] + 
   4*A0[Mass2[VWm]]*Cp[UHpm[{gO1}], conj[UHpm[{gO2}]], conj[VWm], VWm] - 
 ...
 {L0, {sum[gI1, 1, 2, Mass[Cha[{gI1}]]*sum[gI2, 1, 2, 
    ...
    4*sum[gI1, 1, 2, B0[p^2, Mass2[Cha[{gI1}]], Mass2[VWm]]*
       conj[Cp[UChi[{gO2}], bar[Cha[{gI1}]], VWm][PR]]*Mass[Cha[{gI1}]]*
    ...
    sum[gI1, 1, 4, Mass[Chi[{gI1}]]*sum[gI2, 1, 2, 
   ...
   -1/2*sum[gI1, 1, 2, sum[gI2, 1, 2, B1[p^2, Mass2[Cha[{gI1}]], 
    ...
    sum[gI2, 1, 2, B1[p^2, Mass2[Cha[{gI2}]], Mass2[VWm]]*
   ...
   -1/2*sum[gI1, 1, 2, sum[gI2, 1, 2, B1[p^2, Mass2[Cha[{gI1}]], 
         Mass2[Hpm[{gI2}]]]*conj[Cp[UChi[{gO2}], bar[Cha[{gI1}]], Hpm[{gI2}]][
          PL]]*Cp[UChi[{gO1}], bar[Cha[{gI1}]], Hpm[{gI2}]][PL]]] - 
    sum[gI1, 1, 2, sum[gI2, 1, 2, B1[p^2, Mass2[Cha[{gI2}]], 
         Mass2[Hpm[{gI1}]]]*conj[Cp[UChi[{gO2}], conj[Hpm[{gI1}]], 
           Cha[{gI2}]][PL]]*Cp[UChi[{gO1}], conj[Hpm[{gI1}]], Cha[{gI2}]][
         PL]]]/2 - sum[gI1, 1, 2, sum[gI2, 1, 4, 
       B1[p^2, Mass2[Chi[{gI2}]], Mass2[hh[{gI1}]]]*
 ...
 {Cha, {sum[gI1, 1, 2, Mass[Cha[{gI1}]]*sum[gI2, 1, 2, 
   ...
   -1/2*sum[gI1, 1, 2, sum[gI2, 1, 2, B1[p^2, Mass2[Cha[{gI1}]], 
         Mass2[Ah[{gI2}]]]*conj[Cp[bar[UCha[{gO2}]], Cha[{gI1}], Ah[{gI2}]][
          PR]]*Cp[bar[UCha[{gO1}]], Cha[{gI1}], Ah[{gI2}]][PR]]] - 
    sum[gI1, 1, 2, sum[gI2, 1, 2, B1[p^2, Mass2[Cha[{gI2}]], 
         Mass2[hh[{gI1}]]]*conj[Cp[bar[UCha[{gO2}]], hh[{gI1}], Cha[{gI2}]][
   ...
   -1/2*sum[gI1, 1, 2, sum[gI2, 1, 2, B1[p^2, Mass2[Cha[{gI1}]], 
         Mass2[Ah[{gI2}]]]*conj[Cp[bar[UCha[{gO2}]], Cha[{gI1}], Ah[{gI2}]][
          PL]]*Cp[bar[UCha[{gO1}]], Cha[{gI1}], Ah[{gI2}]][PL]]] - 
    sum[gI1, 1, 2, sum[gI2, 1, 2, B1[p^2, Mass2[Cha[{gI2}]], 
         Mass2[hh[{gI1}]]]*conj[Cp[bar[UCha[{gO2}]], hh[{gI1}], Cha[{gI2}]][
 ...
 {Fe, {sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fe[{gI2}]], 
    ...
    4*sum[gI2, 1, 3, B0[p^2, Mass2[Fe[{gI2}]], 0]*
       conj[Cp[bar[UFe[{gO2}]], VP, Fe[{gI2}]][PR]]*Mass[Fe[{gI2}]]*
       Cp[bar[UFe[{gO1}]], VP, Fe[{gI2}]][PL]] - 
    4*sum[gI2, 1, 3, B0[p^2, Mass2[Fv[{gI2}]], Mass2[VWm]]*
       conj[Cp[bar[UFe[{gO2}]], VWm, Fv[{gI2}]][PR]]*Mass[Fv[{gI2}]]*
       Cp[bar[UFe[{gO1}]], VWm, Fv[{gI2}]][PL]] - 
    4*sum[gI2, 1, 3, B0[p^2, Mass2[Fe[{gI2}]], Mass2[VZ]]*
       conj[Cp[bar[UFe[{gO2}]], VZ, Fe[{gI2}]][PR]]*Mass[Fe[{gI2}]]*
       Cp[bar[UFe[{gO1}]], VZ, Fe[{gI2}]][PL]], 
   -1/2*sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fe[{gI2}]], 
         Mass2[hh[{gI1}]]]*conj[Cp[bar[UFe[{gO2}]], hh[{gI1}], Fe[{gI2}]][
          PR]]*Cp[bar[UFe[{gO1}]], hh[{gI1}], Fe[{gI2}]][PR]]] - 
   ...
   -1/2*sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fe[{gI2}]], 
         Mass2[hh[{gI1}]]]*conj[Cp[bar[UFe[{gO2}]], hh[{gI1}], Fe[{gI2}]][
          PL]]*Cp[bar[UFe[{gO1}]], hh[{gI1}], Fe[{gI2}]][PL]]] - 
    sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fv[{gI2}]], 
         Mass2[Hpm[{gI1}]]]*conj[Cp[bar[UFe[{gO2}]], Hpm[{gI1}], Fv[{gI2}]][
 ...
 {Fd, {sum[gI1, 1, 2, sum[gI2, 1, 3, B0[p^2, Mass2[Fd[{gI2}]], 
   ...
   -1/2*sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fd[{gI2}]], 
         Mass2[hh[{gI1}]]]*conj[Cp[bar[UFd[{gO2}]], hh[{gI1}], Fd[{gI2}]][
          PL]]*Cp[bar[UFd[{gO1}]], hh[{gI1}], Fd[{gI2}]][PL]]] - 
    sum[gI1, 1, 2, sum[gI2, 1, 3, B1[p^2, Mass2[Fu[{gI2}]], 
         Mass2[Hpm[{gI1}]]]*conj[Cp[bar[UFd[{gO2}]], Hpm[{gI1}], Fu[{gI2}]][
 ...
 {Glu, {sum[gI1, 1, 3, Mass[Fd[{gI1}]]*sum[gI2, 1, 6, 
    ...
    12*B0[p^2, Mass2[Glu], 0]*conj[Cp[Glu[{gO2}], VG, Glu[{1}]][PR]]*
     Mass[Glu]*Cp[Glu[{gO1}], VG, Glu[{1}]][PL], 
   -1/4*sum[gI1, 1, 3, sum[gI2, 1, 6, B1[p^2, Mass2[Fd[{gI1}]], 
         Mass2[Sd[{gI2}]]]*conj[Cp[Glu[{gO2}], bar[Fd[{gI1}]], Sd[{gI2}]][
          PR]]*Cp[Glu[{gO1}], bar[Fd[{gI1}]], Sd[{gI2}]][PR]]] - 
   ...
   -1/4*sum[gI1, 1, 3, sum[gI2, 1, 6, B1[p^2, Mass2[Fd[{gI1}]], 
         Mass2[Sd[{gI2}]]]*conj[Cp[Glu[{gO2}], bar[Fd[{gI1}]], Sd[{gI2}]][
          PL]]*Cp[Glu[{gO1}], bar[Fd[{gI1}]], Sd[{gI2}]][PL]]] - 
    sum[gI1, 1, 3, sum[gI2, 1, 6, B1[p^2, Mass2[Fu[{gI1}]], Mass2[Su[{gI2}]]]*
        conj[Cp[Glu[{gO2}], bar[Fu[{gI1}]], Su[{gI2}]][PL]]*
 ...
 {VG, (3*(-2*A0[0] - 4*p^2*B0[p^2, 0, 0] - 10*B00[p^2, 0, 0])*
 ...
 {VWm, B00[p^2, Mass2[gWm], Mass2[gP]]*conj[Cp[conj[VWm], bar[gP], gWm]]*
   ...
   conj[Cp[conj[VWm], VWm, VP]]*Cp[conj[VWm], VWm, VP]*
    (-A0[0] - A0[Mass2[VWm]] - 10*B00[p^2, Mass2[VWm], 0] - 
     B0[p^2, Mass2[VWm], 0]*(4*p^2 + Mass2[VWm])) + 
   conj[Cp[conj[VWm], VZ, VWm]]*Cp[conj[VWm], VZ, VWm]*
    (-A0[Mass2[VWm]] - A0[Mass2[VZ]] - 10*B00[p^2, Mass2[VZ], Mass2[VWm]] - 
     B0[p^2, Mass2[VZ], Mass2[VWm]]*(4*p^2 + Mass2[VWm] + Mass2[VZ])) + 
