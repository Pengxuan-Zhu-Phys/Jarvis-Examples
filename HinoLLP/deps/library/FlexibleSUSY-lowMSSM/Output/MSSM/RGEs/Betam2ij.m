{{mq2[i1, i2], (-2*g1^2*MassB*conj[MassB]*Kronecker[i1, i2])/15 - 
  ...
  (-16*g3^2*(120*g3^2*MassG - g1^2*(MassB + 2*MassG) - 
      45*g2^2*(2*MassG + MassWB))*conj[MassG]*Kronecker[i1, i2])/45 + 
   ...
   (g1^2*conj[MassB]*((597*g1^2*MassB + 80*g3^2*(2*MassB + MassG) + 
        45*g2^2*(2*MassB + MassWB))*Kronecker[i1, i2] + 
 ...
 {mHu2, (-6*g1^2*MassB*conj[MassB])/5 - 6*g2^2*MassWB*conj[MassWB] + 
   ...
   6*trace[mu2, Yu, Adj[Yu]], 33*g2^4*MassWB*conj[MassWB] + 
   (9*g1^2*g2^2*(MassB + 2*MassWB)*conj[MassWB])/5 + 6*g2^4*Tr2[2] + 
   (6*g1^2*Tr2U1[1, 1])/5 + 4*Sqrt[3/5]*g1*Tr3[1] + 
 ...
 {me2[i1, i2], (-24*g1^2*MassB*conj[MassB]*Kronecker[i1, i2])/5 + 
  ...
  (2*(20*g1*Kronecker[i1, i2]*(3*g1*Tr2U1[1, 1] + Sqrt[15]*Tr3[1]) + 
     6*conj[MassB]*(234*g1^4*MassB*Kronecker[i1, i2] + 
       5*g1^2*(-2*MassB*MatMul[Ye, Adj[Ye]][i1, i2] + MatMul[T[Ye], Adj[Ye]][
          i1, i2])) - 5*(2*(3*g1^2*mHd2 - 15*g2^2*mHd2 - 
         30*g2^2*MassWB*conj[MassWB] + 30*mHd2*trace[Yd, Adj[Yd]] + 
