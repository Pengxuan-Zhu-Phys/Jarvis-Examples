(* Uisng SARAH generated template for particles.m file for darkLR as a reference*)
...
{Fv,{                                
     ...
     FeynArtsNr -> 1,
     LaTeX -> "\\nu",
     Mass -> {LesHouches, LesHouches, LesHouches, LesHouches, LesHouches, LesHouches, LesHouches, LesHouches, LesHouches},
     OutputName -> "nu",
     PDG -> {12, 14, 16, 6000012, 6000014, 6000016, 6000018, 6000020, 6000022},
     ElectricCharge -> 0,
     Width -> {External, External, External, External, External, External, External, External, External}}},
